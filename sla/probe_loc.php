...
function initialize() {
	...
	var infowindow2 = new google.maps.InfoWindow({content: "Probe point: <a target=blank href=http://www.edu.cn/a>CERNET</a>" });
	...
	var probe_loc = [
		new google.maps.LatLng(36.07052,120.387960),
		new google.maps.LatLng(51.5,    -0.13     ),
		new google.maps.LatLng(52.37472,4.8986167 ),
		new google.maps.LatLng(47.61485,-122.33591),
		new google.maps.LatLng(37.41332,-122.08127),
	];
	for (i=0;i<probe_loc.length;i++){
    	var marker3 = new google.maps.Marker({position: probe_loc[i],map: map});
	}
	var infowindow = new google.maps.InfoWindow({content: "Pathperf monitored websites, format: location, # of websites, #performance"});
	for (var city in citymap) {
		...
		var parts = citymap[city].description.split("<br>");
		var des = parts[0].concat(',&nbsp;',parts[1]);
		bindInfoWindow(marker, map, infowindow, des);
...
-->
    ...
    <div id="legend">
		<h3>Legend</h3>
		<img src="../img/marker.png" alt="Marker" height="30" width="20">&nbsp;&nbsp;&nbsp;Probe<br />
    	<img src="../img/green.gif" alt="Green Star" height="24" width="24">&gt;2MB/s<br />
    	<img src="../img/purple.gif" alt="Yellow Star" height="24" width="24">&gt;200KB/s<br />
