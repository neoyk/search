...
<html>
  <head>
    ...
    <meta charset="utf-8">
    <title>IPv4 web server distribution</title>
...
<?php
	...
	$sql = "select count(*) as num,longitude,latitude from ipv4candidate group by longitude,latitude having num>100 order by num desc ";
...
function initialize() {
  ...
  <body>
	...
	<img src="marker.png" alt="Marker" height="30" width="18">&nbsp;&gt;20000<br />
	</div>  
</body>
</html>
